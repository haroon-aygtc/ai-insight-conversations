...
const WidgetConfigurator = () => {
  ...
  const [widgetConfig, setWidgetConfig] = useState({
    appearance: {
      ...
      chatIconSize: 40,
      fontFamily: "inter",
      theme: "light", // Added theme property
      iconStyle: "circle", // Added icon style property
      customCSS: "", // Added custom CSS property
    },
    behavior: {
      autoOpen: "no",
      delay: 5,
      ...
      persistState: true, // Added persist state property
      showNotifications: true, // Added show notifications property
    },
    content: {
      ...
      showTypingIndicator: true, // Added typing indicator property
      showAvatar: true, // Added show avatar property
    },
    embedding: {
      allowedDomains: "*",
      widgetId: "widget-" + Math.random().toString(36).substring(2, 10),
      enableAnalytics: true, // Added analytics property
      gdprCompliance: true, // Added GDPR compliance property
    },
  });

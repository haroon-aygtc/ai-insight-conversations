...
export function WidgetTestingContainer({
  ...
  const generateEmbedCode = () => {
    ...
    const formattedConfig = {
      appearance: configCopy.appearance_config || {},
      behavior: configCopy.behavior_config || {},
      content: configCopy.content_config || {},
      embedding: configCopy.embedding_config || {},
      // Include any additional configuration sections
      allowedDomains: configCopy.embedding_config?.allowedDomains || "*",
      isActive: configCopy.is_active !== false,
      isPublished: configCopy.is_published === true,
      widgetName: configCopy.name || "AI Chat Widget",
      lastUpdated: configCopy.updated_at || new Date().toISOString(),
    };
  ...
  (function(w, d, s) {
    ...
    j.onload = function() {
      w.AIInsightWidget.init({
        ...
        config: ${JSON.stringify(formattedConfig, null, 2)}
      });
    };
            ...
            <CardContent className="p-0">
              ...
              >
                ...
                <TabsContent value="testing" className="m-0">
                  <div className="p-6">
                    <TestScenarios
                      onRunTest={(scenarioId) =>
                        console.log(`Running test: ${scenarioId}`)
                      }
